...
<body id="top">
  <header class="bg-light">
    <nav class="navbar navbar-expand-lg navbar-light bg-light" id="header-nav" role="navigation">
      <div class="container"><a class="link-dark navbar-brand site-title mb-0" href="#"></a>
    ...
    <div id="content">
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="mt-5">
                  ...
                  <h1 class="intro-title marker" data-aos="fade-left" data-aos-delay="50">I’m Rifaldi Indrajaya</h1>
                  <p class="lead fw-normal mt-3" data-aos="fade-up" data-aos-delay="100">Web Developer & UI/UX Application Developer</p>
                  ...
                  <div class="mt-3" data-aos="fade-up" data-aos-delay="200"><a class="btn btn-primary shadow-sm mt-1 hover-effect" href="https://wa.me/+6289507318790">Get In Touch <i class="fas fa-arrow-right"></i></a></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="section pt-4 px-3 px-lg-4" id="about">
        <div class="container-narrow">
          <div class="row">
            <div class="col-md-6">
              <h2 class="h4 my-2">Hello! I’m Rifaldi Indrajaya</h2>
              ...
              <div class="row mt-3">
                ...
                <div class="col-sm-10">
                  <div class="pb-1 fw-bolder">18</div>
                </div>
                <div class="col-sm-2">
                  <div class="pb-1">Email:</div>
                </div>
                <div class="col-sm-10">
                  <div class="pb-1 fw-bolder">rifaldibpn2@gmail.com</div>
                </div>
                <div class="col-sm-2">
                  <div class="pb-1">Phone:</div>
                </div>
                <div class="col-sm-10">
                  <div class="pb-1 fw-bolder">+62 895-0731-8790</div>
                </div>
                <div class="col-sm-2">
                  <div class="pb-1">Address:</div>
                </div>
                <div class="col-sm-10">
                  <div class="pb-1 fw-bolder">Indonesia, Jawa Timur, Kota Malang</div>
                </div>
              </div>
            </div>
            <div class="col-md-5 offset-md-1" data-aos="fade-left" data-aos-delay="100"><img class="avatar img-fluid mt-2" src="https://scontent-xsp1-2.xx.fbcdn.net/v/t39.30808-6/310006895_1745565102484031_8699651244302056661_n.jpg?_nc_cat=102&ccb=1-7&_nc_sid=09cbfe&_nc_eui2=AeHDJTWYSsvyp_ILRDII4iMpp2z-RbxPTrCnbP5FvE9OsMa7xlP0FLP3wyn0eSwxUqS3TU-lHobfM5znhomWioWr&_nc_ohc=kWtx6j94lQgAX8Q9I08&_nc_ht=scontent-xsp1-2.xx&oh=00_AfA1OzxiGFA2s1UbtvIvDoXe1Dh4VN2K9bzG0SClWimwCg&oe=63F9520C" width="400" height="400" alt="Rifaldi Indrajaya" /></div>
          </div>
        </div>
      </div>
      ...
      </div> <div class="section px-2 px-lg-4 pb-4 pt-5 mb-5" id="contact">
        <div class="container-narrow">
          <div class="text-center mb-5">
          ...
          <div class="row">
            <div class="col-md-6" data-aos="zoom-in" data-aos-delay="100">
              <div class="bg-light my-2 p-3 pt-2">
                <form action="https://formspree.io/f/xrgvqljo" method="POST">
      ...
      <footer class="pt-4 pb-4 text-center bg-light">
        <div class="container">
          <div class="my-3">
            <div class="h4">Rifaldi Indrajaya</div>
            <p>Web Developer & UI/UX Application Developer</p>
